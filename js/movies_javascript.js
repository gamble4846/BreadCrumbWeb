...
function UpdateMovies(){
    ...
    CurrentTitlesDataToUse.forEach(row => {
        let cardHtml = GetCardHTML(row.Movies_MainName, row.Movies_Ver_Poster, row.Movie_IMDB_ID, row.Movies_ReleaseYear, row.Movies_Id, row.Server_ID, invalidIMAGEMovie);
